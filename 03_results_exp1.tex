...
% Dataset
For our first experiment we use synthetic preferential attachment graphs (\citealp{pref_att2002}) and real world chemical molecules of the aids dataset (\href{https://wiki.nci.nih.gov/display/NCIDTPdata/AIDS+Antiviral+Screen+Data}{link}). Both datasets have discrete node and edge features, and graphs are limited to at most 30 nodes. We provide some basic dataset statists in the appendix (Table \ref{tab:ex1-data}).
