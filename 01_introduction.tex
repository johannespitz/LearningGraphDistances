...
\begin{itemize}
    \itemsep0em
    \item The Graph Distance Network (GDN): A model derived from principle properties of metrics and classical algorithms for approximating the GED that uses a classical cost matrix, a soft matching, and fast backpropagation.
    \item Experiments showing that our model improves upon state-of-the-art neural networks in predicting the GED.
    \item Empirical evidence that our classical cost matrix and different application of the sinkhorn normalization improve upon state-of-the-art results of \cite{fey2020_update} in graph matching.
\end{itemize}
