...
As described in \ref{section:related_work} Related Work, \cite{fey2020_update} have recently used a similar model to predict soft matchings between nodes. They train on the negative log likelihood between the soft matching and some ground truth matching (following \citealp{wang2019}). The final performance is measured by how often the row-wise maximum in the soft matching yields the correct match (Hits@1).
